 ...
 * MyCircle that gives it an ability to be moved around the screen, resized and to be rotated
 * using mouse.
 *
 * @author Adam Zeid
 */
public class MyCircleEventHandler implements EventHandler <MouseEvent>
{
    ...
    /**
     * This private void method is checking if MyCircle was hit and if it was it gives it
